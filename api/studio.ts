...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;background:linear-gradient(180deg,#eef3f6 0,#f8fafb 240px,#f3f5f7 100%);color:var(--ink)}
    ...
    .tab{border-color:#cfd8e5}.tab.active{background:#182230;border-color:#182230;color:#fff}.status{min-height:20px;color:#475467;font-size:13px;margin-top:8px;border:1px solid #e1e7ee;background:#f8fafc;border-radius:8px;padding:7px 9px}.meta{font-size:12px;color:var(--muted);line-height:1.4;margin-top:8px;word-break:break-word}
  ...
  <main>
    ...
    <section class="layout">
      <aside class="panel">
        ...
        <div class="tools"><button id="generateText" class="green" type="button">Generiraj tekst</button><button id="clear" class="secondary" type="button">Počisti</button></div>
